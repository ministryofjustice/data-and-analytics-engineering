...
{% set menuItems = [
    { url: "https://dev.to/documatic/pair-programming-best-practices-and-tools-154j#:~:text=Pair%20Programming%20is%20a%20technique,and%20provides%20feedback%20(navigator)", title: "What is pair programming?" }
] %}
{% cardGrid menuItems %}
