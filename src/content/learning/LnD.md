...
{% set menuItems = [
    { url: "https://www.datacamp.com/pricing", title: "DataCamp", description: "DataCamp offers interactive courses in data science, analytics, and engineering with a focus on programming languages like Python and SQL. The platform provides free introductory courses and a free trial for deeper learning in areas like data manipulation, data modeling, and machine learning." },
    { url: "https://www.skillsoft.com/get-free-trial", title: "SkillSoft", description: "Skillsoft provides learning modules covering a wide range of technical skills, including data analysis, cloud platforms, and project management. Their resources also include leadership and soft skills development, which are essential for career growth in data engineering roles." },
    { url: "https://www.oreilly.com/online-learning/individuals.html", title: "O'Reilly", description: "O'Reilly offers comprehensive access to books, tutorials, and videos on a wide range of technical topics. It covers everything from data architecture to cloud computing, Python, R, and data visualization. Their free trial gives you access to these learning materials to build your knowledge base." },
    { url: "https://www.linkedin.com/learning/subscription/trial", title: "LinkedIn Learning", description: "LinkedIn Learning provides courses across various fields, including data science, data engineering, and software development. You can access a free trial to explore courses on Git, Python, SQL, cloud technologies, and more, which are critical for success in a data engineering role." }
] %}
{% cardGrid menuItems %}
