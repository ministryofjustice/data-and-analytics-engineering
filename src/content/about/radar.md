...
Tech radar blips are configured in _blips.json_, while tech radar rings and quadrants are set up in _radar_config.json_. Additional context for the blips is provided by GitHub discussions, which are queried using the GitHub GraphQL API to populate _blips.json_. See [manage_discussions](https://github.com/moj-analytical-services/data-and-analytics-engineering-tech-radar/blob/main/manage_discussions/README.md) for how we do this.
